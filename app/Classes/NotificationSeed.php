...
class NotificationSeed
{
    public static $emailNotificaiotnArray = [
        ...
        'purchases_create' => [
            ...
            'content' => "A new purhcase added by ##staff_member_name## in your warehouse ##warehouse_name## with invoice number ##invoice_number##.",
            'other_data' => []
        ],
        'purchases_update' => [
            'type' => "email_templates",
        ...
        'purchase_returns_create' => [
            'type' => "email_templates",
            'title' => "Purchase created",
            'content' => "A new purhcase return added by ##staff_member_name## in your warehouse ##warehouse_name## with invoice number ##invoice_number##.",
            'other_data' => []
        ],
        ...
        'sales_create' => [
            'type' => "email_templates",
            'title' => "Sales created",
            'content' => "A new sales added by ##staff_member_name## name in your warehouse ##warehouse_name## with invoice number ##invoice_number##.",
            'other_data' => []
        ],
        'sales_update' => [
            'type' => "email_templates",
        ...
        'sales_returns_create' => [
            ...
            'content' => "A new sales return added by ##staff_member_name## in your warehouse ##warehouse_name## with invoice number ##invoice_number##.",
            'other_data' => []
        ],
        ...
        'quotations_create' => [
            ...
            'content' => "A new quotations added by ##staff_member_name## name in your warehouse ##warehouse_name## with invoice number ##invoice_number##.",
            'other_data' => []
        ],
        'quotations_update' => [
            'type' => "email_templates",
            'title' => "Quotations updated",
            'content' => "Quotations with invoice number ##invoice_number## updated by ##staff_member_name## in your warehouse ##warehouse_name##.",
            'other_data' => []
        ],
        'quotations_delete' => [
            'type' => "email_templates",
            'title' => "Quotations deleted",
            'content' => "Quotations with invoice number ##invoice_number## deleted by ##staff_member_name## from your warehouse ##warehouse_name##.",
            'other_data' => []
        ],
